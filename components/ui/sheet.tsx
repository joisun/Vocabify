...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      // Apple-style scrim: lighter, blurred backdrop instead of solid black/80
...
const sheetVariants = cva(
  // Translucent vibrancy panel with soft shadow + hairline border
  "fixed z-50 gap-4 glass text-foreground p-6 shadow-apple-xl border border-border/60 transition ease-spring " +
    ...
    >
      <SheetPrimitive.Close
        className={cn(
          ...
          "transition-[background-color,color,transform] duration-150 ease-spring active:scale-95",
