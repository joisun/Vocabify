...
const AlertDialogContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof AlertDialogPrimitive.Content> & { container?: HTMLElement | null }
>(({ className, container, ...props }, ref) => (
  <AlertDialogPortal container={container ?? getVocabifyPortalContainer()}>
    <AlertDialogOverlay />
    <AlertDialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 grid w-[calc(100vw-2rem)] max-w-[360px] -translate-x-1/2 -translate-y-1/2 gap-3 rounded-[10px] border border-border bg-popover p-4 text-popover-foreground shadow-none outline-none dark:border-white/[0.04]",
